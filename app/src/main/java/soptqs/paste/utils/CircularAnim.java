...
public class CircularAnim {
    ...
    private static boolean swillBack;
    ...
    public static FullActivityBuilder fullActivity(Activity activity, View triggerView, boolean willBack) {
        return new FullActivityBuilder(activity, triggerView, willBack);
    }
    ...
    public static class FullActivityBuilder {
        ...
        public FullActivityBuilder(Activity activity, View triggerView, boolean willBack) {
            mActivity = activity;
            mTriggerView = triggerView;
            swillBack = willBack;
        }
        ...
        public void go(OnAnimationEndListener onAnimationEndListener) {
            ...
            Log.d("mColorOrImageRes", "go: " + mColorOrImageRes);
