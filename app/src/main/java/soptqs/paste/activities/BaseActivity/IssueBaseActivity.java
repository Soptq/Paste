package soptqs.paste.activities.BaseActivity;
...
public abstract class IssueBaseActivity extends AppCompatActivity {
    private static final String TAG = IssueBaseActivity.class.getSimpleName();
    ...
    private void findViews() {
        ...
        qqCommu = findViewById(R.id.qq_qrcode);
    }
    ...
    private void initViews() {
        ...
        qqCommu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ClipData clipData = ClipData.newPlainText(null, "716971999");
                clipboard.setPrimaryClip(clipData);
                ToastUtils.setBgColor(Color.GREEN);
                ToastUtils.showLong(R.string.issue_toast);
            }
        });
...
//                R.drawable.air_ic_send_dark : R.drawable.air_ic_send_light);
        buttonSend.setImageResource(R.drawable.air_ic_send_light);
