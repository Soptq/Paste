...
public class RecommendedLoader {
    ...
    public @NonNull
    Call loadInto(@NonNull final AbsAboutActivity activity, int index) {
//        return null;
    ...
    public @NonNull
    Call loadInto(@NonNull final AbsAboutActivity activity, int index, final boolean showDefaultCategory) {
    ...
    @CheckResult
    private @NonNull
    Call requestRecommendedList(@NonNull String packageName, @NonNull Callback responseCallback) {
